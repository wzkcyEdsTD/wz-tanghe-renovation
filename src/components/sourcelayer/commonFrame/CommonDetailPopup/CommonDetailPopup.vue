        ...
        <div id="content-wrapper" class="content-wrapper">
          <div class="content-item basic-wrapper" id="basic">
            ...
            <ul v-if="!isSpot">
              ...
              <li
                class="info-item"
                style="line-height: 2vh"
                v-if="forceEntity.attributes && forceEntity.attributes.XQ"
              >
          ...
          <div id="photo" class="content-item photo-wrapper">
            ...
            <div
              ...
              v-else-if="
                this.isSpot &&
                this.detailData.photos &&
                this.detailData.photos.length
              "
            >
              <el-image
                style="
          ...
          <div class="content-item video-wrapper" id="video">
            ...
            <div
              ...
              v-if="
                !this.isSpot &&
                this.forceEntity.attributes &&
                this.forceEntity.attributes.SP
              "
            >
              <video
            ...
            <div
              ...
              v-else-if="
                this.isSpot &&
                this.detailData.videos &&
                this.detailData.videos.length
              "
            >
              <video
                v-for="(item, index) in detailData.videos"
                :key="index"
                class="video"
                :src="`${MediaServer}/${item.path}`"
                controls="controls"
          ...
          <div class="content-item video-wrapper" id="audio">
            ...
            <div
              ...
              v-if="
                !this.isSpot &&
                this.forceEntity.attributes &&
                this.forceEntity.attributes.YY
              "
            >
              <AudioTool
                :src="`${MediaServer}/audio/${forceEntity.type}/${this.forceEntity.attributes.YY}`"
              />
            </div>
            <div
              class="video-content"
              v-else-if="this.isSpot && this.detailData.audioSrc"
            >
          ...
          <div class="content-item overall-wrapper" id="overall">
            ...
            <div
              class="overall-content"
              v-if="
                !this.isSpot &&
                this.forceEntity.attributes &&
                this.forceEntity.attributes.ZBQJ
              "
            >
              <img
            ...
            <div
              ...
              v-else-if="
                !this.isSpot &&
                this.forceEntity.attributes &&
                this.forceEntity.attributes.QJ
              "
            >
              <img
            ...
            <div
              ...
              v-else-if="
                this.isSpot &&
                this.detailData.overallViews &&
                this.detailData.overallViews.length
              "
            >
              <img
                v-for="(item, index) in detailData.overallViews"
                :key="index"

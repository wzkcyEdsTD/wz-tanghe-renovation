  ...
  <div class="search">
    <div class="search-box">
      <input
        ...
        @keyup.enter="search"
      />
      <img src="./images/clean.png" @click="clean" />
...
<script>
import { ServiceUrl, MediaServer } from "@/config/server/mapConfig";
import { searchIconHash } from "@/common/js/hash";
import { addLocationIcon, cleanLocationIcon } from "@/components/decision/cesium_map_init";
